...
const Noodoe = () => (
  <CompanyBlock title="Noodoe, Senior Engineer" duration="Oct 2022 ~ Jun 2024">
    <View>
      ...
      <ListItem>獨立與各職能: designer, PM, backend, QA 銜接，確保功能符合需求，時程符合預期。</ListItem>
      <ListItem>實作 charger load management 功能，提供使用者介面以動態調整充電量分配，使客戶能夠配合電價政策達到降低成本之目的。</ListItem>
      <ListItem>實作 log management 功能，提供使用者回顧系統操作記錄之功能，減少公司內部營運之成本。 </ListItem>
